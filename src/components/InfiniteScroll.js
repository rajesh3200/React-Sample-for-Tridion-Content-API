...
var InfiniteScroll = function (_Component) {
  ...
  _createClass(InfiniteScroll, [{
    ...
    value: function componentWillUpdate() {
      if(this.props.resetInfiniteScroll){
        this.pageLoaded = 0
      }
    }
  }, {
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          resetInfiniteScroll = _props.resetInfiniteScroll,
          props = _objectWithoutProperties(_props, ['children', 'element', 'hasMore', 'initialLoad', 'isReverse', 'loader', 'loadMore', 'pageStart', 'ref', 'threshold', 'useCapture', 'useWindow', 'resetInfiniteScroll']);
...
InfiniteScroll.propTypes = {
  ...
  resetInfiniteScroll: _propTypes2.default.bool
};
